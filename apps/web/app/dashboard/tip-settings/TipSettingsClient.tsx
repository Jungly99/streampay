  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <div style={{ ...C, padding: '24px 28px' }}>
        <p style={{ fontSize: 14, fontWeight: 700, color: 'var(--text-1)', marginBottom: 18 }}>Minimum Tip Amount</p>
        <div style={{ maxWidth: 240 }}>
          ...
          <p style={{ fontSize: 12, color: 'var(--text-3)', marginTop: 8 }}>Viewers cannot tip below this amount. Max ₹10,000.</p>
        </div>
      </div>
      ...
      <div style={{ ...C, padding: '24px 28px' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 6 }}>
          <div>
            <p style={{ fontSize: 14, fontWeight: 700, color: 'var(--text-1)' }}>Message Character Tiers</p>
            <p style={{ fontSize: 12, color: 'var(--text-3)', marginTop: 4 }}>Higher tips unlock longer messages. The highest matching tier applies.</p>
          </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 40px', gap: 10, padding: '10px 0 6px', borderBottom: '1px solid rgba(255,255,255,0.06)', marginBottom: 8 }}>
          <span style={{ fontSize: 11, fontWeight: 600, color: 'var(--text-3)', letterSpacing: '0.06em', textTransform: 'uppercase' }}>Min Amount (₹)</span>
          <span style={{ fontSize: 11, fontWeight: 600, color: 'var(--text-3)', letterSpacing: '0.06em', textTransform: 'uppercase' }}>Char Limit</span>
          <span />
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
        <div style={{ ...C, padding: '22px 24px' }}>
          <p style={{ fontSize: 14, fontWeight: 700, color: 'var(--text-1)', marginBottom: 6 }}>What Viewers See</p>
          <p style={{ fontSize: 12, color: 'var(--text-3)', marginBottom: 16 }}>Your tier list appears on the donation page as viewers pick an amount</p>
          <div style={{ background: 'rgba(0,0,0,0.3)', borderRadius: 12, padding: '16px', border: '1px solid rgba(255,255,255,0.06)' }}>
            <p style={{ fontSize: 11, fontWeight: 600, color: 'var(--text-3)', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 10 }}>Message Tiers</p>
            {sorted.length === 0 ? (
              <p style={{ fontSize: 12, color: 'var(--text-3)' }}>Add tiers above to see the preview</p>
            ) : sorted.map((tier, i) => (
        ...
        <div style={{ ...C, padding: '22px 24px' }}>
          <p style={{ fontSize: 14, fontWeight: 700, color: 'var(--text-1)', marginBottom: 6 }}>How Tiers Work</p>
          <p style={{ fontSize: 12, color: 'var(--text-3)', marginBottom: 16 }}>The highest tier the viewer's donation meets unlocks the most characters</p>
